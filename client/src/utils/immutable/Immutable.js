 ...
 */
const merge = (...objects) => {
    return Immutable(deepMerge.all(objects));
};
...
const push = (array: any[], ...args: any) => {
    return _arrayApply(array, 'push', ...args);
};
const pop = (array: any[], ...args: any) => {
    return _arrayApply(array, 'pop', ...args);
};
const shift = (array: any[], ...args: any) => {
    return _arrayApply(array, 'shift', ...args);
};
const unshift = (array: any[], ...args: any) => {
    return _arrayApply(array, 'unshift', ...args);
};
const reverse = (array: any[], ...args: any) => {
    return _arrayApply(array, 'reverse', ...args);
};
const sort = (array: any[], ...args: any) => {
    return _arrayApply(array, 'sort', ...args);
};
const splice = (array: any[], ...args: any) => {
