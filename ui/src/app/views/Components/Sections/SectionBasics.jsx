...
import CustomInput from 'app/components/CustomInput/CustomInput.jsx';
import CustomLinearProgress from 'app/components/CustomLinearProgress/CustomLinearProgress.jsx';
import Paginations from 'app/components/Pagination/Pagination.jsx';
import Badge from 'app/components/Badge/Badge.jsx';

import basicsStyle from 'app/assets/jss/material-kit-react/views/componentsSections/basicsStyle.jsx';
...
class SectionBasics extends React.Component {
    ...
    componentDidMount() {
        nouislider.create(this.refs.slider1, { // eslint-disable-line
            start: [40],
            connect: [true, false],
            step: 1,
            range: { min: 0, max: 100 },
        });
        nouislider.create(this.refs.slider2, { // eslint-disable-line
            start: [20, 60],
                    ...
                    <div id="sliders">
                        <GridContainer>
                            <GridItem xs={12} sm={12} md={6}>
                                ...
                                <div ref="slider1" className="slider-primary" /> {/* eslint-disable-line */}
                                <br />
                                <div ref="slider2" className="slider-info" /> {/* eslint-disable-line */}
                            </GridItem>
                            <GridItem xs={12} sm={12} md={6}>
                                <div className={classes.title}>
                                    <h3>Badges</h3>
