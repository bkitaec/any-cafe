                ...
                <div className={classes.container}>
                    <GridContainer className={classes.textCenter} justify="center">
                        ...
                        <GridItem xs={12} sm={8} md={6}>
                            ...
                            <Button color="primary" size="lg" href="https://www.creative-tim.com/product/material-kit" target="_blank">
                                Free HTML Downoad
                            </Button>
                        </GridItem>
                    </GridContainer>
                    ...
                    <GridContainer className={classes.textCenter} justify="center">
                        <GridItem xs={12} sm={12} md={8}>
                            ...
                            <h4>
                                We{`'`}ve launched{' '}
                                <a href="https://www.creative-tim.com/product/material-kit-pro-react">Material Kit PRO React </a>
